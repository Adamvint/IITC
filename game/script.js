...
function createBoard() { // makes the board
    myBoard = [];
    while (true) {
...
function displayStatistics() { // display the game statistics
...
function main() { // main function includes all the of the game
    //users enter the names they choose for them selfs :
    const playersNames = [getUserName("Hello Player1 Please enter your name"), getUserName("Hello Player2 Please enter your name")];
    let numOfRounds = 1;

    let runGame = true;
    // starts the game ends when the user says no
    while (runGame == true) {
        createBoard();
        ...
        //Choose what marker each player gets
